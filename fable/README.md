...
MacOS/Linux | Windows
--- | ---
[![Travis Badge](https://travis-ci.org/MyGithubUsername/Fable.FsSpec.Fable.svg?branch=master)](https://travis-ci.org/MyGithubUsername/Fable.FsSpec.Fable) | [![Build status](https://ci.appveyor.com/api/projects/status/github/MyGithubUsername/Fable.FsSpec.Fable?svg=true)](https://ci.appveyor.com/project/MyGithubUsername/Fable.FsSpec.Fable)
[![Build History](https://buildstats.info/travisci/chart/MyGithubUsername/Fable.FsSpec.Fable)](https://travis-ci.org/MyGithubUsername/Fable.FsSpec.Fable/builds) | [![Build History](https://buildstats.info/appveyor/chart/MyGithubUsername/Fable.FsSpec.Fable)](https://ci.appveyor.com/project/MyGithubUsername/Fable.FsSpec.Fable)
...
Stable | Prerelease
--- | ---
[![NuGet Badge](https://buildstats.info/nuget/Fable.FsSpec.Fable)](https://www.nuget.org/packages/Fable.FsSpec.Fable/) | [![NuGet Badge](https://buildstats.info/nuget/Fable.FsSpec.Fable?includePreReleases=true)](https://www.nuget.org/packages/Fable.FsSpec.Fable/)
